module.exports = {
  pathPrefix: 'gatsby-starter-portfolio-emma', // Prefix for all links. If you deploy your site to example.com/portfolio your pathPrefix should be "portfolio"
  siteTitle: 'Emma', // Navigation and Site Title
  siteTitleAlt: 'Emma - Gatsby Starter Portfolio', // Alternative Site title for SEO
  siteUrl: 'https://joemidi.github.io/', // Domain of your site. No trailing slash!
